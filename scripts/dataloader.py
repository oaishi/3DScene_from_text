...
#             print((data_items))    
        ...
        return hidden_state, last_hidden, color_list_index.long(), shape_list_index.long(), size_list_index.long(), texture_list_index.long() , length
...
#             print((data_items))    
        ...
        return hidden_state, last_hidden, color_list_index.long() , shape_list_index.long() , size_list_index.long() , texture_list_index.long() , motion_list_index.long() , length
