...
parser.add_argument('--output_image_dir', default='/output/image_dir/images/',
    help="The directory where output images will be stored. It will be " +
         "created if it does not exist.")
parser.add_argument('--output_scene_dir', default='/output/image_dir/scenes/',
    help="The directory where output JSON scene structures will be stored. " +
         "It will be created if it does not exist.")
parser.add_argument('--output_scene_file', default='/output/image_dir/CLEVR_scenes.json',
    help="Path to write a single JSON file containing all scene information")
parser.add_argument('--output_blend_dir', default='/output/image_dir/blendfiles',
...
def main(args):
  ...
  for i in range(args.num_images):
    ...
    num_objects = 1 #random.randint(args.min_objects, args.max_objects)
    render_scene(args,
...
def add_random_objects(scene_struct, num_objects, args, camera):
  ...
  for i in range(len(input_objects['objects'])):
    ...
    print('obj_name_out',obj_name_out)
...
#     mat_name, mat_name_out = random.choice(material_mapping)
    ...
    print('mat_name_out',mat_name_out)
